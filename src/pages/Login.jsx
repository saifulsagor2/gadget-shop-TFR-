        ...
        <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
          <form className="card-body" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-control mt-6">
              <button type="submit" className="btn bg-slate-700 text-white font-bold rounded-md 
                      border border-black">Login</button>
            </div>
            <GoogleLogin/>
            <p className="my-4 text-sm font-thin">New Here? <Link to={"/register"} className="font-bold rounded-md text-slate-700">Register</Link></p>
          </form>
        </div>
      </div>
    </div>
